...
There is an example config file in [config/config.hocon.sample](https://raw.githubusercontent.com/sahara/google-cloud-dataflow-example-project/release/0.1.0/config/config.hocon.sample). If you've been using the same names as we did, you'll only need to perform some minimal changes, specifically:
...
Copyright 2017 Sahara Labs Ltd.
